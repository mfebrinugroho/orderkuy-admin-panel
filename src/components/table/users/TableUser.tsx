...
const TableUser = () => {
  return (
    <>
      <div className="overflow-hidden rounded-xl border border-gray-200 bg-white pt-4 dark:border-white/[0.05] dark:bg-white/[0.03]">
        ...
        <div className="max-w-full overflow-x-auto">
          <Table>
            ...
            <TableHeader className="border-b border-gray-200 dark:border-gray-800">
              <TableRow className="grid grid-cols-12 border-t border-gray-200 dark:border-gray-800">
                <TableCell
                  isHeader
                  className="col-span-4 flex items-center border-r border-gray-200 px-4 py-3 dark:border-gray-800"
                >
            ...
            <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
              {tableData.map((order) => (
                <TableRow
                  key={order.id}
                  className="grid grid-cols-12 border-t border-gray-100 dark:border-gray-800"
                >
                  <TableCell className="col-span-4 flex items-center border-r border-gray-100 px-4 py-[17.5px] dark:border-gray-800">
                    <div className="flex items-center gap-3">
        ...
        <div className="border-t border-gray-100 py-4 pl-[18px] pr-4 dark:border-gray-800">
          <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between">
            <div className="flex items-center justify-center gap-0.5 pb-4 xl:justify-normal xl:pt-0">
              ...
              {/* active 'bg-blue-500/[0.08] text-brand-500' : 'text-gray-700 dark:text-gray-400' */}
